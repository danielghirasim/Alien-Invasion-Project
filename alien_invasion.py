...
def run_game():
    ...
    while True:
        ...
        if stats.game_active:
            ...
            gf.update_bullets(aliens, bullets, my_settings, my_ship, screen)

        gf.display_update(screen, my_ship, my_settings, bullets, aliens, my_background, play_button, stats)
